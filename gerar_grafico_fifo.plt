...
set output 'grafico_fifo.png'

# --- Configurações do seu gráfico ---
set title "Tempo Médio de Espera (FIFO)"
...
plot "grafico_fifo.dat" using 1:2:($3**0.5) with yerrorlines title "Média TME com Desvio Padrão"